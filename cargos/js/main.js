document.addEventListener("DOMContentLoaded", async () => {
	const tabela = document.querySelector("#tabela-cargos tbody");
	if (tabela) {
		const produtos = await fetchCargos();
		produtos.forEach((p) => {
		...
		buttons: [
			{
				extend: 'copy',
				text: 'Copiar',
				title: "Lista de Cargos", // Evita que o <title> da página seja incluído
				exportOptions: {
